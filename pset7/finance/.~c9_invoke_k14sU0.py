...
def index():
    ...
    return render_template("index.html", portfolio=portfolio, cash=usd(cash[0]["cash"]), assets=usd(assets))
...
def history():
    ...
    db.execute("SELECT symbol, shares, price, transacteddetcasnart ,ecirp ,serahs ,lobmys TCELES""")()etucexe.bd    
                          FROM history \
